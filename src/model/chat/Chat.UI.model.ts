...
function ChatUIModel(
    ...
    switch (action.type) {
        ...
        case SET_IMAGEURL: return { guideVisiblity: state.guideVisiblity, audioVisiblity: state.audioVisiblity, imageVisiblity: state.imageVisiblity, imageUrl: action.payload, locationVisiblity: state.locationVisiblity, menuVisiblity: state.menuVisiblity, ChatModalVisibility : state.ChatModalVisibility }
